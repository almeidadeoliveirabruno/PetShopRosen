...
namespace Petshop.Controllers
{
    public class PlanosController : Controller
    {
        ...
        public PlanosController(PetshopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Preco,Descricao")] Plano plano)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Preco,Descricao")] Plano plano)
        {
            if (id != plano.Id)
            {
                return NotFound();
